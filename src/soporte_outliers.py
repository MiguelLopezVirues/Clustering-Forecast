...
def capar_imputar(
        df, vr, column, outlier_column, score_column, threshold=0.15, upper_percentile=99, lower_percentile=1) -> pd.Series:
    """
...
class GestionOutliersMultivariados:
    ...
    def explorar_outliers_lof(self, var_dependiente, indice_contaminacion=[0.01, 0.05, 0.1], vecinos=[600, 1200], colores={-1: "red", 1: "grey"}):
        """
        ...
        for combinacion in combinaciones:
            print(f"Vecinos {combinacion[0]}. Contaminacion {combinacion[1]}")
